...
class ConnectStreams extends React.Component {
    componentDidMount() {
     ...
     render() {
       ...
       return (
   <div className="g3cm_holder" data-module={this.props.moduleId} data-showoninit="true" data-calloninit="false" data-conversionid="" data-destination="" data-destinationext="" data-followup="">Thank you for your inquiry. A representative will be in contact with you shortly.</div>
       );
